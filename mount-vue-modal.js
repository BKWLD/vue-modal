...
var mountInside = function (element, component, options = {}, append = true) {
  return new Promise(function (resolve) {
    var attachMethod, mount, ref; // Set default options

    if (!options.parent) {
      options.parent = (ref = window.$nuxt) != null ? ref.$root : void 0;
    } // Mount the component
    ...
    mount = function () {
      var vm;
      vm = new (vue__WEBPACK_IMPORTED_MODULE_0___default.a.extend(component))(options);
      vm.$mount();
...
/* harmony default export */ __webpack_exports__["default"] = (mountVueModal = function (component, options = {}) {
  return Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["mountOnBody"])(component, options);
});
